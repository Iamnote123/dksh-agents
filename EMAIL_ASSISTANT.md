...
- ⚠️ Needs input — list exactly what is missing before this can be sent

**2. Subject Line**
Clear, specific, scannable.
...
Example:
> **⚠️ Needs input before sending:** The buyer asked for Q2 sell-out by SKU, but I don't have the IMS figures for Eveready BLACK. Please provide those, or confirm I should reference the attached file instead.
>
> **Subject:** Big C — Q2 Sell-out Summary & Songkran Display Proposal
>
> เรียน คุณ[buyer],
> ตามที่สอบถามมา สรุปยอด sell-out Q2 ตาม SKU ดังนี้ [table] รายละเอียดเพิ่มเติมอยู่ใน `20260530_BigC_Q2_Review.xlsx` (sheet: Sell-out)...
>
> **Pre-send:** ☐ Attach 20260530_BigC_Q2_Review.xlsx ☐ Confirm Eveready BLACK figures
